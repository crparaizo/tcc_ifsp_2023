//https://microdigisoft.com/esp32-esp8266-passing-input-data-on-html-form-web-server/
...
void funcao()
{
  ...
  if(teste != "1"){
    Serial.println("Valor ainda é 0");    
    Serial.println(teste);    
  } else{
    Serial.println("Houve mudança!");  
    Serial.println(teste);    
    valorDelay = 500;
    teste = "0"; 
    troca = "0";  
...
void setup() {
  ...
  server.on("/get", HTTP_GET, [] (AsyncWebServerRequest *request) {
    ...
    // GET input2 value on <ESP_IP>/get?input2=<inputMessage>
      ...
      troca = request->getParam(TEXT_INPUT2)->value();
    }
